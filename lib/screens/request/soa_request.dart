...
class SOARequestScreen extends BasePage {
  static const routeName = '/SOARequestScreen';

  @override
  _SOARequestScreenState createState() => _SOARequestScreenState();
}

class _SOARequestScreenState extends BaseState<SOARequestScreen> {
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Text(
              multiLanguage.translate("soa_requests"),
  ...
  showSOARequestDialog() {
    showAdaptiveAlertDialog(
        context: context,
        title: MultiLanguage.of(context)!.translate("soa"),
        content: MultiLanguage.of(context)!.translate(
            "soa_request_confirm"), //"Are you sure to place a request for SOA?",
        defaultActionText: MultiLanguage.of(context)!.translate("ok"), //ok
        cancelActionText:
  ...
  sendSOARequest() async {
    Map<String, dynamic> params = Map();
    params["CustName"] = pref.userName;
    params["RequestType"] = "SOA";
