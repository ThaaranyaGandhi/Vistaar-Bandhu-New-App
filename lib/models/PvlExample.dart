...
class PvlOfferModel {
    ...
    factory PvlOfferModel.fromJson(Map<String, dynamic> json) {
        return PvlOfferModel(
            d: json['d'] != null ? (json['d'] as List).map((i) => PvlList.fromJson(i)).toList() : null,
        );
    }
...
class PvlList {
    ...
    PvlList({this.type, this.aDHAR_CARD, this.aGE, this.aGEASON, this.aPPLIEDAMOUNT, this.branchcode, this.branchname, this.cUSTOMER_ID, this.cUSTOMER_NAME, this.customerConsent, this.dISBURSE_AMT, this.dISB_DT, this.dRIVING_LICENCE, this.fIRSTINSTAMT, this.iD, this.iNSTALLMENTSTARTDATE, this.iNTEREST_RATE, this.imagePath, this.lASTINSTAMT, this.lOAN_PRODUCT_TYPE_ID, this.mATURITYDATE, this.offeredEMI, this.offeredLoanAmount, this.offeredProduct, this.offeredProductdesc, this.offeredROI, this.offeredTenure, this.pAN_CARD, this.pRODUCTCD, this.rATIONCARD, this.sZ_EDUCATION, this.sZ_LAND_LINE_NO, this.sZ_LOAN_ACCOUNT_NO, this.sZ_MSTATUS, this.sZ_SPOUSE_NAME, this.sZ_VOTERSID, this.source, this.sourceID, this.tENURE, this.tOT_NET_INC});
